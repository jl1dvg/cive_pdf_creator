...
<TABLE>
    ...
    <tr>
        ...
        <td class="blanco" width="40%"><?php echo htmlspecialchars($diagnostic1Detail); ?></td>
        <td class="blanco" width="8%"><?php echo htmlspecialchars($diagnostic1CIE10); ?></td>
    ...
    <tr>
        ...
        <td class="blanco" width="40%"><?php echo htmlspecialchars($diagnostic2Detail); ?></td>
        <td class="blanco" width="8%"><?php echo htmlspecialchars($diagnostic2CIE10); ?></td>
